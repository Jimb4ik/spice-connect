/**
 * Демонстрационный скрипт для Lavrilo
...
const LavriloDemo = {
    ...
    async fullDemo() {
        console.log('🚀 Запуск полной демонстрации Lavrilo');
        console.log('===========================================');
    ...
    help() {
        console.log(`
🎯 Lavrilo Demo - Доступные функции:
...
if (typeof window !== 'undefined') {
    window.demo = LavriloDemo;
    
    // Автоматически показать справку при загрузке
    console.log('🎯 Lavrilo Demo загружен!');
